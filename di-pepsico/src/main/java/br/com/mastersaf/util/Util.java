...
public class Util {
	...
	public static final Pattern A_LOWER_ACENTUADO = Pattern.compile("[áàâãäåª]");
	public static final Pattern E_LOWER_ACENTUADO = Pattern.compile("[éêëè]");
	public static final Pattern I_LOWER_ACENTUADO = Pattern.compile("[iiiiii]");
	public static final Pattern O_LOWER_ACENTUADO = Pattern.compile("[öóôòõº]");
	public static final Pattern U_LOWER_ACENTUADO = Pattern.compile("[uuuuu]");
	public static final Pattern A_UPPER_ACENTUADO = Pattern.compile("[AAAAAAAAA]");
	public static final Pattern E_UPPER_ACENTUADO = Pattern.compile("[ÉÊËÈ]");
	public static final Pattern I_UPPER_ACENTUADO = Pattern.compile("[IIIIII]");
	public static final Pattern O_UPPER_ACENTUADO = Pattern.compile("[OOOOOO]");
	public static final Pattern U_UPPER_ACENTUADO = Pattern.compile("[UUUUUUU]");
	public static final Pattern NUMERIC = Pattern.compile("\\d{1,}");
	public static final Pattern CEDILHA_UPPER = Pattern.compile("Ç");
	public static final Pattern CEDILHA_LOWER = Pattern.compile("ç");
	 ...
	 *
	 * @param text
	 * @return text com espaços substituídos por -
	 */
	...
	/**
	 * Auxiliar para Substring de 0 a X caracteres, mantém o valor passado caso
	...
	/**
	 * Auxiliar para Substring de X a length caracteres, mantém o valor passado
	...
	/**
	 * Coloca a String em caixa baixa, não dá NullPointer
	 *
	 * @param str
	 * @return
	 */
	...
	/**
	 * Verifica se expressão existe, não dá NullPointer
	 * @param str
	 * @return
	 */
	...
	/**
	 * Retorna se a Coleção passada está vazia
	 *
	 * @param Collection
	 * @return
	 */
	...
	public static String camelize(String texto) {
		if(isEmpty(texto)) throw new IllegalArgumentException("Argumento texto não pode ser vazio");

		return Util.left(texto, 1).toUpperCase() + Util.right(texto, texto.length() - 1);
	}

	/**
	 * Coloca a String em caixa alta, não dá NullPointer
	 *
	 * @param str
	 * @return
	 */
	...
	public static boolean isWindowsSO() {
		try {
			...
			// Qualquer problema de segurança considerará como não sendo executado no Windows
		}
	...
	/**
	 * Retorna o primeiro valor não nulo na lista de valores fornecidos, ou nulo caso todos os
	 * valores sejam nulos.
	 */
	 ...
	 * hora é devolvido um int em minutos.
	 * @param cron
	 * @return
	 */
	public static int tranformaCronInt(String cron) {
		if(Util.isEmpty(cron)) throw new IllegalArgumentException("Argumento cron não pode ser vazio");
