...
public class FreemarkerTemplateRulesFactory extends Configuration implements ITemplateRulesFactory {
	...
	// Contém lista dos templates disponÃ­veis organizados por templatePath
	...
	/**
	 * Lista e armazena templates disponÃ­veis no path informado. Armazena resultados num mapa this.availableTemplates(path, List)
	 * 
	 * @param path
	 * @throws GeradorException
	 */
