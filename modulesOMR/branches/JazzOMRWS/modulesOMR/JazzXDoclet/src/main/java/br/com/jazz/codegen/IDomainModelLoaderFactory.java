...
/**
 * Contrato para implementação de fábrica abstrata responsável por carregar o modelo de domÃ­nio para geração de código
 * 
 * @author darcio
 * 
 */
public interface IDomainModelLoaderFactory {
	...
	/**
	 * Lista modelo de domÃ­nio carregado.
	 * 
	 * @return Todos as entidades de dominio disponÃ­veis
	 */
	public abstract Map<String, JavaClass> getDomainMap();
	
	/**
	 * Lista modelo de domÃ­nio permitindo forcar refresh do ultimo estado do modelo lido
	 * 
	 * @param forceRefresh
