...
public abstract class AbstractGeradorController implements IGeradorController {
	...
	// Contém regras para criação de writers que servirá de saÃ­da para a geracao de codigo
	...
	/**
	 * Lista as entidades do modelo de domÃ­nio pesquisado
	 * 
	 * @return
	 */
	...
	/**
	 * Retorna o mapa de variï¿½veis para processamento de templates.
	 * 
	 * @param javaClass
	 * @param templateRules
	 * @return
	...
	/**
	 * Retorna o mapa de variï¿½veis de ambiente. <br>
	 * <br>
	 * Corrige a divergï¿½ncia entre o nome da variï¿½vel de ambiente que guarda o nome do usuï¿½rio da sessao.
	 * 
	 * @return
	 */
