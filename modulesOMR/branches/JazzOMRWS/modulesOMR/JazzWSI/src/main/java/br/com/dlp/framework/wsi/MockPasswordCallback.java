...
public class MockPasswordCallback extends BaseCallback {
	...
	private void checkAutentication(WSPasswordCallback pc) throws IOException {
		// Implementaï¿½ï¿½o para validar se a aplicaï¿½ï¿½o tem acesso ao serviï¿½o e se
		// a senha estï¿½ correta
		if (pc.getIdentifier() == null) {
			throw new IOException("Chamada nï¿½o autorizada.");
		}
		...
		// throw new IOException("Cï¿½digo de aplicaï¿½ï¿½o invï¿½lido");
		// }
