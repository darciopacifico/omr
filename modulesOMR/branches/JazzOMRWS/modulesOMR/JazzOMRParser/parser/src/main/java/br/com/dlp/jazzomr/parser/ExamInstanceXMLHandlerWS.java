...
public class ExamInstanceXMLHandlerWS extends DefaultHandler {
	...
	protected Integer getExamVar(Matcher aco_matcher) {
		...
		if(!NumberUtils.isDigits(examVar))throw new JazzRuntimeException("Erro ao tentar preencher coordenadas! O valor de examVar "+examVar+" nao é numerico!");
	...
	protected Integer getPagina(Matcher aco_matcher) {
		...
		if(!NumberUtils.isDigits(pagina))throw new JazzRuntimeException("Erro ao tentar preencher coordenadas! O valor de pagina "+pagina+" nao é numerico!");
