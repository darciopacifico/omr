...
public class ImageDocLogger {
	...
	public void logImageProcessing(ImageDocVO imageDoc, ParticleAnalyzerParamDTO particleAnalyzerParamDTO, String fileSufix, String logDescription, boolean copyImage) throws JazzOMRException {
		...
		writeImageFileLog(imageDoc, fileSufix,  bi);
	}
	 ...
	 * @throws JazzOMRException
	 */
	protected void writeImageFileLog(ImageDocVO imageDoc, String fileSufix, BufferedImage bi) throws JazzOMRException {
		if(!log.isDebugEnabled()){
			return;
		}
		...
		try {
			...
			throw new JazzOMRException("erro ao tentar logar estado de processamento de imagem )", e);
		}
	}
	...
	protected void logaIdentificador(ImageDocVO imageDoc, ParticleAnalyzerParamDTO particleAnalyzerParamDTO, Graphics2D graphics2d) {
		...
		if (imageDocPK == null) {
			drawLargeMsg(bi,graphics2d, "Tentando ler QRCode!");
			return;
		}
	...
	public Graphics2D getOpenedGraphics2D()  {
		...
		if(this.graphics2D==null){
			throw new JazzOMRRuntimeException("O graphics 2d nao foi aberto!");
		}
	...
	public void closeGraphics2D() throws JazzOMRException{
		...
		writeImageFileLog(this.imageDoc, this.fileSufix, this.bi);
	...
	public void logBullet(CriterionResultVO criterionResultVO) {
		...
		logBullet(criterionResultVO, (BufferedImage)criterionResultVO.getCroppedImage(), criterionResultVO.getTransientResultAnalysis());
	}
