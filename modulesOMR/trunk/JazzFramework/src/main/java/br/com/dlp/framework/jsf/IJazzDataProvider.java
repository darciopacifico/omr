 ...
 * O JazzDataModel provÃª um mecanismo de paginação para o componente DataTable do RichFaces.
 * <br>
 * <br>
 * A Solução de design recomendada prevÃª que o próprio JSF ManagedBean implemente o IJazzDataProvider
 * e, através de uma referÃªncia de componente de negócio, realize as pesquisas paginadas e ordenadas.
 * 
 * @author t_dpacifico
 *
 */
public interface IJazzDataProvider<B extends IBaseVO<? extends Serializable>> {
	...
	/**
	 * Determina se o registro referente Ã  PK currentPk está disponÃ­vel
	 * @param currentPk
	 * @return
	 */
