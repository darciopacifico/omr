...
public class StatusBusinessImpl extends AbstractBusinessImpl<StatusVO> implements StatusBusiness {
	 ...
	 * @returns Coleção de StatusVO
	 */
	public List<StatusVO> findStatusVOOrdered(String titulo, String descricao, ExtraArgumentsDTO  metaArgument){
		return statusDAO.findStatusVO(titulo, descricao, metaArgument);
	}
