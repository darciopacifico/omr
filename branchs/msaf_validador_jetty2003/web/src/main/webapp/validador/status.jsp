  ...
  <tr>
    ...
    <TABLE width="600" border=1 align="center" cellPadding=3 cellSpacing=0 borderColor=#003366>
      ...
      <TR vAlign=center align=middle borderColor=#cccccc>
        <TD colspan="5" bordercolor="#003366" class="title1"><div align="left">resultado dos registros <spam style="font-size: 8px; font-weight: 8px;">(<input type="checkbox" name="hdPermiteReload"  id="hdPermiteReload"  /> Atualização Automática)</spam> </div></TD>
