...
public class RegistroPessoaDAOImplTest {
	...
	private Logger log = Logger.getLogger(RegistroPessoaDAOImplTest.class);
	
	private PessoaVO getDadosRegPessoa() throws Exception{
	...
	private PedValidacaoVO getPedValidacaoVO( PessoaVO dadosRet) throws Exception{
	...
	@Test
	public void testCriarRegistroPessoa() throws Exception {
		...
		if(log.isDebugEnabled()) log.debug("Criacao de registro...");
