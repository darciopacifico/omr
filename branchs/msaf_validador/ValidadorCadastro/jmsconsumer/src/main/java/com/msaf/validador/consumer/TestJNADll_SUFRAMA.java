 ...
 *
 */
public class TestJNADll_SUFRAMA {
	...
	protected static final class ThreadCnpjUF extends Thread {
		...
		public void run() {
			...
			TestJNADll_SUFRAMA dll = new TestJNADll_SUFRAMA();
			dll.testDllValidador(cnpj,estado);

		}
	}

	Logger log = Logger.getLogger(TestJNADll_SUFRAMA.class);
...
//		mapCnpjUF.put("06916424000187","ES");
		...
		TestJNADll_SUFRAMA.contador = mapCnpjUF.size();
