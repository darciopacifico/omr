...
public class TestJNADll_IBGE {
	...
	protected static final class ThreadCnpjUF extends Thread {
		...
		public void run() {
			...
			TestJNADll_IBGE dll = new TestJNADll_IBGE();
			dll.testDllValidador(cnpj,estado);

		}
	}

	Logger log = Logger.getLogger(TestJNADll_IBGE.class);
...
//		mapCnpjUF.put("06916424000187","ES");
		...
		TestJNADll_IBGE.contador = mapCnpjUF.size();
