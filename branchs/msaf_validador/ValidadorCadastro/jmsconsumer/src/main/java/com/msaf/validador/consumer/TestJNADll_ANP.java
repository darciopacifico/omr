...
public class TestJNADll_ANP {
	...
	protected static final class ThreadCnpjUF extends Thread {
		...
		public void run() {
			...
			TestJNADll_ANP dll = new TestJNADll_ANP();
			dll.testDllValidador(cnpj,estado);

		}
	}

	Logger log = Logger.getLogger(TestJNADll_ANP.class);
...
//		mapCnpjUF.put("06916424000187","ES");
		...
		TestJNADll_ANP.contador = mapCnpjUF.size();
