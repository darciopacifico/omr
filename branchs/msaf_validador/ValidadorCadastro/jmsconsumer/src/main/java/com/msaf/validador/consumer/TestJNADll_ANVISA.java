 ...
 *
 */
public class TestJNADll_ANVISA {
	...
	protected static final class ThreadCnpjUF extends Thread {
		...
		public void run() {
			...
			TestJNADll_ANVISA dll = new TestJNADll_ANVISA();
			dll.testDllValidador(cnpj,estado);

		}
	}

	Logger log = Logger.getLogger(TestJNADll_ANVISA.class);
...
//		mapCnpjUF.put("06916424000187","ES");
		...
		TestJNADll_ANVISA.contador = mapCnpjUF.size();
