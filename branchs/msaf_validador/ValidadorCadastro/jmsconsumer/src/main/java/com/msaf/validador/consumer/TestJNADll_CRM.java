...
public class TestJNADll_CRM {
	...
	protected static final class ThreadCnpjUF extends Thread {
		...
		public void run() {
			...
			TestJNADll_CRM dll = new TestJNADll_CRM();
			dll.testDllValidador(cnpj,estado);

		}
	}

	Logger log = Logger.getLogger(TestJNADll_CRM.class);
...
//		mapCnpjUF.put("06916424000187","ES");
		...
		TestJNADll_CRM.contador = mapCnpjUF.size();
