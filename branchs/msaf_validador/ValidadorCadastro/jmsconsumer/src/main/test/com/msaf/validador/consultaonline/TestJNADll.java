...
//		 if(log.isDebugEnabled()) log.debug("Inicio consulta Sintegra");
...
//		 if(log.isDebugEnabled()) log.debug("Feita uma consulta! Sintegra");
		 if(log.isDebugEnabled()) log.debug("Inicio consulta CRM");
		 resultado =
		consultaOnLine.DBI_EfetuaConsultaServico(8,geraXmlDePedidoValidacaoCRM
		 ("33484","SP"),dllServer, dllServer);
		 if(log.isDebugEnabled()) log.debug(resultado);
		 if(log.isDebugEnabled()) log.debug("Feita uma consulta! CRM");
//		 if(log.isDebugEnabled()) log.debug("Inicio consulta Anvisa");
//		 resultado = consultaOnLine.DBI_EfetuaConsultaServico(9,
//		 geraXmlDePedidoValidacaoAnvisa("06273675000271"),dllServer,
//		 dllServer);
//		 if(log.isDebugEnabled()) log.debug(resultado);
//		 if(log.isDebugEnabled()) log.debug("Feita uma consulta! Anvisa");
//		 if(log.isDebugEnabled()) log.debug("Inicio consulta MunicipioIBGE");
//		 resultado = consultaOnLine.DBI_EfetuaConsultaServico(10,
//		 geraXmlDePedidoValidacaoMunicipioIBGE("Sao Paulo", "SP"),dllServer,
//		 dllServer);
//		 if(log.isDebugEnabled()) log.debug(resultado);
//		 if(log.isDebugEnabled()) log.debug("Feita uma consulta! MunicipioIBGE");
//		 if(log.isDebugEnabled()) log.debug("Inicio consulta ANP");
//		 resultado =
//		 consultaOnLine.DBI_EfetuaConsultaServico(13,geraXmlDePedidoValidacaoANP
//		 ("03222638000165"),dllServer, dllServer);
//		 if(log.isDebugEnabled()) log.debug(resultado);
//		 if(log.isDebugEnabled()) log.debug("Feita uma consulta! ANP");

		 if(log.isDebugEnabled()) log.debug("Inicio consulta Federal");
		 resultado = consultaOnLine.DBI_EfetuaConsultaServico(3,
				 geraXmlDePedidoValidacaoFederal("45842622010249"),dllServer,
		 dllServer);
		 if(log.isDebugEnabled()) log.debug(resultado);
		 if(log.isDebugEnabled()) log.debug("Feita uma consulta! Federal");
	}
...
// dllServer);
// if(log.isDebugEnabled()) log.debug(resultado2);
// if(log.isDebugEnabled()) log.debug("Feita uma consulta! RS");
//
...
// dllServer);
// if(log.isDebugEnabled()) log.debug(resultado3);
// if(log.isDebugEnabled()) log.debug("Feita uma consulta! SP");