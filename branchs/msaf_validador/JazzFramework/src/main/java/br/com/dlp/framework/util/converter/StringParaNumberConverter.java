...
public class StringParaNumberConverter extends AbstractConverter {
	...
	/**
	 * Constroi um StringParaNumberConverter baseado em configuracoes
	 * internacionalizadas
	 */
	...
	public Object convert(Class classeDoSetter, Object objetoOrigem) {
		...
		/*
		 * recupera o padrao de casas decimais e separadores de milhar do
		 * sistema, independentemente das configuracoes regionais do SO
		 */
		...
		try {
			...
			returnValue = null;
			logger.error("NÃO FOI POSSIVEL CONVERTER  DO VALOR " + objetoOrigem
					+ " PARA O TIPO " + classeDoSetter.getName());
		}
	...
	/**
	 */
	protected Number getNumber(String valorDeOrigem, String propertyFormato,
			DecimalFormatSymbols decimalFormatSymbols) throws ParseException {
