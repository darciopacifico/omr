...
/**
 * Organizar a ordem de precedência os atributs de chave a ser analizada,
 * exemplo:<br>
 * 1 - Valores null<br>
 * 2 - Primitivos<br>
...
public class PrecedenciaCamposPKComparator implements Comparator {
	...
	protected Log logger = LogFactory
			.getLog(PrecedenciaCamposPKComparator.class);
	...
	public int compare(Object object1, Object object2) {
		...
		try {
			...
			logger.error("Erro ao tentar estabelecer precedencia entre campos "
					+ object1 + " e " + object2);
			return 0;
