...
/**
 * Implementação abstrata de Converter para forçar internacionalização do
 * contrato
 */
public abstract class AbstractConverter implements Converter {
	...
	/**
	 * Construtor que recebe resourceBundle para internacionalização dos
	 * formatos
	 */
	 ...
	 *             conversão padrão<br>
	 *             É altamente recomendável que se construa este objeto
	 *             informando o resourceBundle de internacionalizacao
	 */
	public AbstractConverter() {
		logger
				.warn("ATENCAO!! CONSTRUINDO UM RESOURCE BUNDLE COM A INTERNACIONALIZAÇÃO DE "
						+ "FORMATOS PADRÃO!!!. ISTO PODE COMPROMETER A PORTABILIDADE DA APLICACAO");
	...
	/**
	 * Recupera o padrao de casas decimais e separadores de milhar do sistema,
	 * independentemente das configuracoes regionais do SO
	 * 
	 * @return Objeto contendo as informacoes sobre formatacao de números
	 *         utilizado para converter numeros para Strings e vice e versa
	 */
	public DecimalFormatSymbols getDecimalFormatSymbols() {

		ResourceBundle resourceBundle = getResourceBundle();

		String strDecimalSeparator = resourceBundle
				.getString(PROPERTY_DECIMAL_SEPARATOR);
		String strGroupingSeparator = resourceBundle
				.getString(PROPERTY_GROUPING_SEPARATOR);
