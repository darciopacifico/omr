...
/**
 * IMPLEMENTAÇÃO DE Converter PARA UTILIZAR O BeanUtilsBean
 */
public class DateParaStringConverter extends AbstractConverter {
	...
	public Object convert(Class classToSetter, Object objectFromGetter) {
		...
		if (objectFromGetter instanceof Date
				&& classToSetter.getName().equals(String.class.getName())) {

			String formato = getResourceBundle().getString(
