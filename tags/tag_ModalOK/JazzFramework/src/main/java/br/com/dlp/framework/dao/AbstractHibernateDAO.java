 ...
 * 
 */
public class AbstractHibernateDAO<B extends IBaseVO<? extends Serializable>> extends HibernateDaoSupport implements IDAO<B> {
	...
	public boolean exists(B baseVO) {
		Object entity = getHibernateTemplate().get(getVoClass(),baseVO.getPK());
	 ...
	 * @param propertyName
	 */
	protected void eqRestriction(Object value, DetachedCriteria criteria, String propertyName) {
		if (value != null) {
	 ...
	 * @param propertyName
	 */
	protected void rangeRestriction(Object valueA, Object valueB, DetachedCriteria criteria, String propertyName) {
