...
public class TemplateLoaderTest {
	...
	public static void main(String[] args) throws IOException, TemplateException, InterruptedException {
		...
		// prova de conceito para caching de templates. Classloader é o melhor, pois funciona em tempo de desenvolvimento e produção, permitindo salvar novo
		// template no quente

		Template template = configuration.getTemplate("teste.ftl");
		while (true) {
