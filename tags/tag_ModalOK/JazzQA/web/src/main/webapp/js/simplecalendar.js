	...
	*****************************************************************************************************
	*/
	var timeoutDelay = 500; // milliseconds, change this if you like, set to 0 for the calendar to never auto disappear
	var g_startDay = 0// 0=sunday, 1=monday
	
	// preload images
	var imgUp = new Image(8,12);
	imgUp.src = '../assets/calendario/up.gif';
	var imgDown = new Image(8,12);
	imgDown.src = '../assets/calendario/down.gif';
