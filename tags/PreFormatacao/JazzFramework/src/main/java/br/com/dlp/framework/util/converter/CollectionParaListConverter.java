...
/**
 * TRANSFERE OS VOS DE UMA COLECAO QUALQUER PARA UMA IMPLEMENTACAO DE List (ArrayList)<br>
 * Normalmente List e utilizado na parte view (Struts) e Set na parte Model (Hibernate)
 */
public class CollectionParaListConverter extends AbstractConverter {

	/**
	 * Este Converter Nao precisa de internacionalizacao
	 */
