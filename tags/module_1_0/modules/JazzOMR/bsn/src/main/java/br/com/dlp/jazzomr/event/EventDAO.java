...
public interface EventDAO extends IJazzOMRDAO<EventVO>{
	 ...
	 * @returns Coleção de EventVO
	 */
	Long countEventVO(String description, Date dtFimFrom, Date dtFimTo, Date dtInicioFrom, Date dtInicioTo, Date dtIncFrom, Date dtIncTo, Date dtAltFrom, Date dtAltTo, StatusEnum status, Boolean hasParts);
	...
	public abstract List<EventVO> findEventVO(String description, Date dtFimFrom, Date dtFimTo, Date dtInicioFrom, Date dtInicioTo, Date dtIncFrom, Date dtIncTo, Date dtAltFrom, Date dtAltTo, StatusEnum status,
			ExtraArgumentsDTO extraArgumentsDTO, Boolean hasParts, String... fetchProfile);
}
