...
public class ParticleAnalyzerParamDTO {
	...
	public double getAvgParticleRadius(List<? extends java.awt.geom.Point2D.Double > pontos) {
		...
		Double maxX = (Double) AbstractEntityVO.getMax("x", pontos);
		Double maxY = (Double) AbstractEntityVO.getMax("y", pontos);

		Double minX = (Double) AbstractEntityVO.getMin("x", pontos);
		Double minY = (Double) AbstractEntityVO.getMin("y", pontos);
