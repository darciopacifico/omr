...
public abstract class AbstractJazzOMRBusinessImpl<B extends IBaseVO<? extends Serializable>> extends AbstractBusinessImpl<B> implements IJazzOMRBusiness<B> {
	...
	/* (non-Javadoc)
	 * @see br.com.dlp.jazzomr.base.IJazzOMRBusiness#getEmpresaUsuarioLogado()
	 */
	@Override
	 ...
	 */
	@Override
	public ImageLogoVO getLogoEmpresa() {
		String loginName = SecurityHelper.getInstance().getLoginName();
		...
		String hqlQuery = 
				...
				" from PessoaVO pes " +
				" inner join pes.empresaVO emp " +
				" inner join emp.logos logos " +
				" where pes.login = :loginName ";
				
		List<ImageLogoVO> logos = hibernateTemplate.findByNamedParam(hqlQuery, "loginName", loginName);
