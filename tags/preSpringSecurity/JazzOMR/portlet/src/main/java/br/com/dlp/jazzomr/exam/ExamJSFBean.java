...
public class ExamJSFBean extends AbstractJazzOMRJSFBeanImpl<ExamVO> {
	...
	private List<QuestionnaireVO> freeQuestionnaires;
 	...
 	public void setTmpVO(ExamVO tmpVO) {
 		...
 		if(tmpVO!=null && tmpVO.getPK()!=null){
 			...
 			tmpVO = business.findByPK(tmpVO, "exame_com_questionarios");
 			
 			populaListaQuestionarios(tmpVO);
 		}
	 ...
	 * @param tmpVO
	 */
	protected void populaListaQuestionarios(ExamVO tmpVO) {
		List<QuestionnaireVO> questionnairesNotIn = questionnaireBusiness.findAllNotIn(tmpVO.getQuestionnaires());
		setFreeQuestionnaires(questionnairesNotIn);
	}
	...
	/**
	 * @return the freeQuestionnaires
	 */
	public List<QuestionnaireVO> getFreeQuestionnaires() {
		return freeQuestionnaires;
	}



	/**
	 * @param freeQuestionnaires the freeQuestionnaires to set
	 */
	public void setFreeQuestionnaires(List<QuestionnaireVO> freeQuestionnaires) {
		this.freeQuestionnaires = freeQuestionnaires;
	}
}