...
public class JazzQRCodeReader {
	...
	public static void main(String[] args) throws IOException, NotFoundException, ChecksumException, FormatException {
		...
		JazzQRCodeReader.decode("QRCodeError_1302282431352_null.gif");
		JazzQRCodeReader.decode("QRCodeError_1302282431291_null.gif");
		JazzQRCodeReader.decode("QRCodeAtuals.png");
		JazzQRCodeReader.decode("QRCodeAtual.png");
		JazzQRCodeReader.decode("QRCodeAtualm.png");
