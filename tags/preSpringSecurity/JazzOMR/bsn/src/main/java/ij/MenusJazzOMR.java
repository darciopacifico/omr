...
public class MenusJazzOMR extends Menus{
	...
	private static MenusJazzOMR instance;
	...
	MenusJazzOMR(ImageJ ijInstance, Applet appletInstance) {
		super(ijInstance,appletInstance);
		ij = ijInstance;
	...
	*/
	...
	public static void updateImageJMenus() {
		...
		MenusJazzOMR m = new MenusJazzOMR(IJ.getInstance(), IJ.getApplet());
