...
public class ProdutoBusinessImpl extends AbstractBusinessImpl<ProdutoVO> implements ProdutoBusiness {
	 ...
	 * @returns Coleção de ProdutoVO
	 */
	public List<ProdutoVO> findProdutoVOOrdered(String dsAreaProduto, Date dtInclusaoFrom, Date dtInclusaoTo, String nome, String obs, QueryOrder... queryOrders){
		return produtoDAO.findProdutoVO(dsAreaProduto, dtInclusaoFrom, dtInclusaoTo, nome, obs, queryOrders);
	}
