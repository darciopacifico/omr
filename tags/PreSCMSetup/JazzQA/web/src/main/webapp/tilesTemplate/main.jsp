...
<body class="corpo" topmargin="2" leftmargin="2" onkeypress="onKeyPress(window.event.keyCode)" >
 <div border="0" id="conteudo" style="width:100%; height:100%; overflow-x:auto; overflow-y:auto;">
  <TABLE border="2" cellpadding="0" cellspacing="0" width="100%">
    <tr>
	  <td class="neutro" valign="top">
